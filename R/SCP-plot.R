...
GroupHeatmap <- function(srt, features = NULL, group.by = NULL, split.by = NULL, within_groups = FALSE, grouping.var = NULL, numerator = NULL, cells = NULL,
                         ...
                         legend_title = NULL, limits = NULL,
                         lib_normalize = identical(slot, "counts"),
                         libsize = NULL,
                         feature_split = NULL,
                         feature_split_by = NULL, n_split = NULL, split_order = NULL,
                         split_method = c("kmeans", "hclust", "mfuzz"),
                         decreasing = FALSE, fuzzification = NULL, show_fuzzification = FALSE,
                         ...
                         db_update = FALSE, db_version = "latest",
                         db_combine = FALSE, convert_species = FALSE,
                         ...
                         pvalueCutoff = NULL, padjustCutoff = 0.05, topTerm = 5,
                         show_termid = FALSE, topWord = 20, min_word_length = 3,
                         exclude_words = c("cell", "cellular", "dna", "rna", "protein", "development", "involved", "organization", "system", "regulation", "positive", "negative", "response", "process"),
                         nlabel = 0,
                         features_label = NULL,
                         label_size = 10, label_color = "black",
                         ...
                         fill_palette = "Dark2", fill_palcolor = NULL,
                         ...
                         cell_annotation_params = if (flip) list(width = grid::unit(1, "cm")) else list(height = grid::unit(1, "cm")),
                         feature_annotation = NULL,
                         feature_annotation_palette = "Dark2",
                         feature_annotation_palcolor = NULL,
                         feature_annotation_params = list(),
                         use_raster = NULL, raster_device = "png",
                         raster_by_magick = FALSE, height = NULL, width = NULL, units = "inch",
...
#' @export
#'
EnrichmentPlot <- function(srt, db = "GO_BP", group_by = NULL,
                           test.use = "wilcox", res = NULL,
